...
class VQ_VAE2(torch.nn.Module):
    def __init__(self, in_channels, latent_dimension, kernel_sizes, res_layers, code_book_size, lower_bound_factor):
        ...
        self.quantization_bottom = QuantizationLayer(latent_dimension, code_book_size, lower_bound_factor)
        ...
        self.quantization_top = QuantizationLayer(latent_dimension // 2, code_book_size, lower_bound_factor)
